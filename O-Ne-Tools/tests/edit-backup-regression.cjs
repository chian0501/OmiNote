...
assert.strictEqual(backup.version, '1.3.1');
...
const tools = [
  ...
  ['explanation-card.html', 'explanation-card', 'V0.4.5'],
...
assert.strictEqual(registry.shared_ai_json_guide.version, 'V1.3.1_20260901');
...
assert.strictEqual(registry.shared_edit_backup.version, 'V1.3.1_20260901');
...
assert.strictEqual(registry.shared_ui_shell.version, 'V1.3.1_20260901');
assert.strictEqual(registry.shared_ui_shell.single_completion_dock_per_page, true);
