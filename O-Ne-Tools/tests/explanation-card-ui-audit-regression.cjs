...
assert(html.indexOf('explanation-card-format-tools-v1.js?v=3')<html.indexOf('explanation-card-ui-audit-v1.js?v=1'),'UI audit must run after format tools exist');
