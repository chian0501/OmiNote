...
assert.strictEqual(guide.guides['explanation-card'].version, 'V0.3.9');
assert.strictEqual(guide.example('explanation-card').data.layoutMode, 'image-below');
assert.strictEqual(guide.example('explanation-card').data.blocks.length, 1);
