...
assert.strictEqual(guide.example('explanation-card').data.mode, 'content');
assert.strictEqual(guide.example('explanation-card').data.sequence.enabled, true);
assert.strictEqual(guide.example('explanation-card').data.sequence.frames.length, 3);
assert.strictEqual(guide.example('explanation-card').data.sequence.frames[0].image.fit, 'free');
assert.strictEqual(guide.example('explanation-card').data.sequence.frames[0].image.cropWidth, 70);
