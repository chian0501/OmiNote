...
(function (global) {
  ...
  var GUIDES = {
    ...
    'explanation-card': {
      name: '說明卡', code: 'EXPLANATION-CARD', version: 'V0.4.1', file: '說明卡-卡片標題-純圖片拼圖.json', image: true, projectFile: '說明卡 .onecard 專案檔',
      ...
      example: {
        schema: 'o-ne.explanation-card.formal.v0.4.1', status: 'READY', generator_version: 'V0.4.1_20260831',
        data: {
